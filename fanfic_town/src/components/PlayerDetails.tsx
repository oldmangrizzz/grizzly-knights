  ...
  return (
    <>
      ...
      <div className="desc my-6">
        <div className="leading-tight -m-4 bg-brown-700 text-base sm:text-sm p-4">
          {isMe && <i>This is you!</i>}
          {!isMe && (
            <>
              <h3 className="font-display text-xl mb-2 border-b border-brown-600">Psych Report</h3>
              <div className="whitespace-pre-wrap font-body opacity-90">
